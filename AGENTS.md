...
- Portfolio sourced from local markdown files in src/content/portfolio/
...
- Portfolio frontmatter fields: title, description, category, url, preview_image
...
- src/pages/portfolio/index.astro - Portfolio page with project listing and modal detail
...
- src/components/PortfolioCard.astro - Individual portfolio project card component
...
- src/content/portfolio/ - Directory containing portfolio project markdown files
...
- src/lib/portfolio.ts - Reads portfolio projects from local markdown files
...
9. Adding new portfolio project - Create .md file in src/content/portfolio/ with frontmatter (title, description, category, url, preview_image)
